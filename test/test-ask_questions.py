...
def test_ask_missing_question(config,citizen,dt): 
    aq.ask_missing_question(config,citizen,dt)
...
def test_ask_missed_trip_question(config,citizen):
    pass
...
def main():
    ...
    #ttest_ask_practice_question(config,test_citizen)
    test_ask_failsafe_question(config,test_citizen,datetime(2019,8,16))
    #test_ask_missing_question(config,test_citizen,datetime(2019,8,17))
